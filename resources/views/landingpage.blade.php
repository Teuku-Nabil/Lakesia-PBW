...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="/css/LandingPage/LandingPageStyle.css">
    </head>
    ...
    <body>
        ...
        <form method="post">
            <table class="login">
                ...
                <tr> 
                    <td>
                       <br> <a class="masuklansia" href=login/lansia>Masuk Sebagai Lansia</a>
                    </td>
                <tr>
                    <td>    
                       <br><br> <a class="masukperawat" href=login/perawat>Masuk Sebagai Perawat</a>
                    </td>    
                </tr>
